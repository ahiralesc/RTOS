...
#define LL_FLASH_LATENCY_15                FLASH_ACR_LATENCY_15WS   /*!< FLASH fifteen wait states */
	...
	__STATIC_INLINE void LL_SYSCFG_SetTIMBreakInputs(uint32_t Break) {
		MODIFY_REG(SYSCFG->CFGR2,
				SYSCFG_CFGR2_LOCKUP_LOCK | SYSCFG_CFGR2_PVD_LOCK, Break);
	}
	 ...
	 * @retval None
	 */
	__STATIC_INLINE uint32_t LL_SYSCFG_DFSDM_GetBitstreamClockSourceSelection(
			void) {
	 ...
	 * @retval None
	 */
	__STATIC_INLINE uint32_t LL_SYSCFG_DFSDM1_GetTIM4OC2BitStreamDistribution(
			void) {
		return (uint32_t) (READ_BIT(SYSCFG->MCHDLYCR,
	 ...
	 * @retval None
	 */
	__STATIC_INLINE uint32_t LL_SYSCFG_DFSDM1_GetTIM4OC1BitStreamDistribution(
			void) {
		return (uint32_t) (READ_BIT(SYSCFG->MCHDLYCR,
	 ...
	 * @retval None
	 */
	__STATIC_INLINE uint32_t LL_SYSCFG_DFSDM2_GetTIM3OC4BitStreamDistribution(
			void) {
		return (uint32_t) (READ_BIT(SYSCFG->MCHDLYCR,
	 ...
	 * @retval None
	 */
	__STATIC_INLINE uint32_t LL_SYSCFG_DFSDM2_GetTIM3OC3BitStreamDistribution(
			void) {
		return (uint32_t) (READ_BIT(SYSCFG->MCHDLYCR,
	 ...
	 * @retval None
	 */
	__STATIC_INLINE uint32_t LL_SYSCFG_DFSDM2_GetTIM3OC2BitStreamDistribution(
			void) {
		return (uint32_t) (READ_BIT(SYSCFG->MCHDLYCR,
	 ...
	 * @retval None
	 */
	__STATIC_INLINE uint32_t LL_SYSCFG_DFSDM2_GetTIM3OC1BitStreamDistribution(
			void) {
		return (uint32_t) (READ_BIT(SYSCFG->MCHDLYCR,
