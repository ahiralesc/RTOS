...
osThreadId persistentTaskHandle;
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* definition and creation of persistentTask */
  osThreadDef(persistentTask, persistentTaskHook, osPriorityNormal, 0, 128);
  persistentTaskHandle = osThreadCreate(osThread(persistentTask), NULL);
...
/* USER CODE BEGIN Header_persistentTaskHook */
/**
  * @brief  Function implementing the persistentTask thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_persistentTaskHook */
void persistentTaskHook(void const * argument)
{
  /* USER CODE BEGIN 5 */
  /* Infinite loop */
