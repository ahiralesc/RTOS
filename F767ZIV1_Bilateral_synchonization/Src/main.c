...
osSemaphoreId signalRedSemHandle;
osSemaphoreId signalBlueSemHandle;
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* definition and creation of signalRedSem */
  osSemaphoreDef(signalRedSem);
  signalRedSemHandle = osSemaphoreCreate(osSemaphore(signalRedSem), 1);

  /* definition and creation of signalBlueSem */
  osSemaphoreDef(signalBlueSem);
  signalBlueSemHandle = osSemaphoreCreate(osSemaphore(signalBlueSem), 1);
