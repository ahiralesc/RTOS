...
Before coding, we must flash the ESP module. Flashing enables loading a firmware software to the ESP, in this example I use [micropython](https://micropython.org/download/#esp8266). The general procedure is the following:
