...
/* Definitions for toggleBlue */
osThreadId_t toggleBlueHandle;
const osThreadAttr_t toggleBlue_attributes = {
  .name = "toggleBlue",
  .stack_size = 128 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
/* Definitions for signalRedSem */
osSemaphoreId_t signalRedSemHandle;
const osSemaphoreAttr_t signalRedSem_attributes = {
  .name = "signalRedSem"
};
/* Definitions for signalBlueSem */
osSemaphoreId_t signalBlueSemHandle;
const osSemaphoreAttr_t signalBlueSem_attributes = {
  .name = "signalBlueSem"
};
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* creation of signalRedSem */
  signalRedSemHandle = osSemaphoreNew(1, 1, &signalRedSem_attributes);

  /* creation of signalBlueSem */
  ...
  /* creation of toggleBlue */
  toggleBlueHandle = osThreadNew(toggleBlueHook, NULL, &toggleBlue_attributes);
...
/* USER CODE BEGIN Header_toggleBlueHook */
/**
* @brief Function implementing the toggleBlue thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_toggleBlueHook */
void toggleBlueHook(void *argument)
{
	for(;;) {
