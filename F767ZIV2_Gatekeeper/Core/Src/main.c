...
/* Definitions for writerOne */
osThreadId_t writerOneHandle;
const osThreadAttr_t writerOne_attributes = {
  .name = "writerOne",
  .priority = (osPriority_t) osPriorityNormal,
  .stack_size = 128 * 4
};
/* Definitions for writerTwo */
osThreadId_t writerTwoHandle;
const osThreadAttr_t writerTwo_attributes = {
  .name = "writerTwo",
  .priority = (osPriority_t) osPriorityNormal,
  .stack_size = 128 * 4
};
/* Definitions for gateKeeper */
osThreadId_t gateKeeperHandle;
const osThreadAttr_t gateKeeper_attributes = {
  .name = "gateKeeper",
  .priority = (osPriority_t) osPriorityNormal,
  .stack_size = 128 * 4
};
